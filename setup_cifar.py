...
## code taken from https://github.com/carlini/nn_robust_attacks/blob/master/setup_cifar.py
...
class CIFARModel:
    ...
    # IF WE HAVE IN RESTORE THE PATH TO THE ARCHITECTURE AND NOT JUST THE WEIGHTS USE THESE FUNCTIONS:
    def __init__(self, restore, session=None):
        self.model = load_model(restore, compile=False)
    

    def predict(self, data):
        return self.model(data, training=False)  # evita dropout, batchnorm etc.
